...
{
    public static string ToCsv(TabularData table, char delimiter = ',')
    {
    ...
    public static string ToTsv(TabularData table) => ToCsv(table, '\t');

    public static string ToMarkdownTable(TabularData table)
    {
    ...
    public static string ToJsonArrayOfObjects(TabularData table, bool indented = true)
    {
    ...
    public static string ToJsonArrayOfArrays(TabularData table, bool indented = true)
    {
    ...
    public static string ToSqlInsertStatements(TabularData table, string tableName = "MyTable")
    {
    ...
    public static string ToHtmlTable(TabularData table)
    {
        var sb = new StringBuilder();
