...
{
    public static StructuredDataParseResult Parse(string? text)
    {
    ...
    public static StructuredDataParseResult TryParseJson(string json)
    {
        try
        {
    ...
    public static StructuredDataParseResult TryParseXml(string xml)
    {
        try
        {
    ...
    public static StructuredDataParseResult TryParseYaml(string yaml)
    {
        try
        {
